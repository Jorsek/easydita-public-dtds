...
<!-- PUBLIC "-//JORSEK//ELEMENTS DITA Guide Map Group Domain//EN"         -->
<!--       Delivered as file "guideMapGroup.mod"                             -->
<!-- ============================================================= -->
...
<!ATTLIST  anchorref    %global-atts;  class CDATA "+ map/topicref   guideMapGroup-d/anchorref">
<!ATTLIST  keydef       %global-atts;  class CDATA "+ map/topicref  guideMapGroup-d/keydef">
<!ATTLIST  flattopicref %global-atts;  class CDATA "+ map/topicref  guideMap/flattopicref"  >
<!ATTLIST  flattopicgroup   %global-atts;  class CDATA "+ map/topicref   guideMapGroup-d/flattopicgroup"     >
<!ATTLIST  topichead    %global-atts;  class CDATA "+ map/topicref  guideMapGroup-d/topicref">
<!ATTLIST  topicset     %global-atts;  class CDATA "+ map/topicref  guideMapGroup-d/topicset">
<!ATTLIST  topicsetref  %global-atts;  class CDATA "+ map/topicref  guideMapGroup-d/topicsetref">
